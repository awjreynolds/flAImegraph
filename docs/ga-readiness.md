...
| Release engineering | Clean install, supported Node/platform CI, package contents, migration notes, licence notices and reproducible checks | Local source tests and viewer build pass; patched viewer audit reports zero advisories. Linux/macOS Node22/24 matrix configured; remote results and final support scope remain pending. |
