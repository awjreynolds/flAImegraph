...
await build({ stdin: { contents: 'export * from "./src/usage.ts"; export * from "./src/usage-profile.ts"; export * from "./src/usage-import.ts"; export * from "./src/efficiency.ts"; export * from "./src/benchmark-import.ts"; export * from "./src/lifecycle.ts";', sourcefile: 'usage-browser.ts', resolveDir: root, loader: 'ts' }, outfile: resolve('viewer/lib/usage.js'), bundle: true, format: 'esm', platform: 'browser', target: 'es2022', minify: true });
for (const [source, destination] of [['usage','usage-core'],['usage-types','usage-types'],['usage-profile','usage-profile'],['usage-import','usage-import'],['efficiency','efficiency'],['efficiency-types','efficiency-types'],['benchmark-import','benchmark-import'],['lifecycle','lifecycle'],['lifecycle-types','lifecycle-types']]) {
