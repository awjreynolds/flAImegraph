...
export default function UsageExplorer() {
  ...
  return <main className="usage-explorer">
    ...
    <div className="usage-controls">
      ...
      <label>Import format<select value={format} onChange={event => setFormat(event.target.value)}><option value="auto">Usage / lifecycle / legacy report JSON</option>{['codex','codex-exec','claude','claude-transcript','pi','openai','anthropic','gemini','otel'].map(value => <option value={value} key={value}>{value}</option>)}</select></label>
